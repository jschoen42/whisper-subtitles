"""
    ...
    PUBLIC:
     - import_caption(dirname: Path|str, basename: str) -> None | Tuple[List[Dict[str, Any]], int, List[int]]
     - export_srt(captions: List[Dict[str, Any]], fps: float = 30) -> str
     - export_vtt(captions: List[Dict[str, Any]], fps: float = 30) -> str
    ...
    PRIVATE:
     - writefile_srt(data_captions: List[Dict[str, Any]], dirname: Path | str, basename: str) -> None
     - writefile_vtt(data_captions: List[Dict[str, Any]], dirname: Path | str, basename: str) -> None
"""
