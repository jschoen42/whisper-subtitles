    ...
    def generate_segments(
        ...
        while clip_idx < len(seek_clips):
            ...
            (
                ...
                compression_ratio,
                result_log,                                                                                  # JS
            ) = self.generate_with_fallback(encoder_output, prompt, tokenizer, options, special_lastsegment) # JS
    ...
    def get_prompt(
        ...
        if previous_tokens or (hotwords and not prefix):
            ...
            if previous_tokens:
                ...
                tmp = previous_tokens[-220:] # JS - 154 ### - fail 96 fail, 46 ok, 56 ok, 66 ok, 76 (80) ok, 86 (90) fail, 81 (85) ok, 83 (87) ok, 84 (88) fail
